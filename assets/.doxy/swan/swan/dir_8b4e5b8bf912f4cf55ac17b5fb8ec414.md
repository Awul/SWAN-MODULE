...
# Dir C:/Users/schliep/Documents/Software/ESP32/i2c\_tools



[**FileList**](files.md) **>** [**i2c\_tools**](dir_8b4e5b8bf912f4cf55ac17b5fb8ec414.md)
...
| Type | Name |
| ---: | :--- |
| file | [**pytest\_examples\_i2c\_tools.py**](pytest__examples__i2c__tools_8py.md) <br> |
...
| Type | Name |
| ---: | :--- |
| dir | [**build**](dir_ede94c15cb3e0e8de7ba00822344cd09.md) <br> |
| dir | [**main**](dir_3218ba971dba91160485f06c6137239b.md) <br> |
...
* `i2cconfig`: It will configure the I2C bus with specific GPIO number, port number and frequency.
* `i2cdetect`: It will scan an I2C bus for devices and output a table with the list of detected devices on the bus.
* `i2cget`: It will read registers visible through the I2C bus.
* `i2cset`: It will set registers visible through the I2C bus.
* `i2cdump`: It will examine registers visible through the I2C bus.
...
------------------------------
The documentation for this class was generated from the following file `C:/Users/schliep/Documents/Software/ESP32/i2c_tools/`
